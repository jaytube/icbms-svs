...
public class KkLoginUtil {
    ...
    private static String getCode() {
        ...
        JSONObject codeJsonObj = JSONObject.parseObject(codeJson);
    ...
    private static Map<String, String> getAccessToken(String code) {
        ...
        JSONObject accessTokeJsonObj = JSONObject.parseObject(accessTokenJson);
    ...
    private static Map<String, String> refreshAccessToken(String refreshToken) {
        ...
        JSONObject refreshTokenJsonObj = JSONObject.parseObject(refreshTokenJson);
    ...
    public static void main(String[] args) {
        String code = KkLoginUtil.getCode();
		/*String code = getCode();		
